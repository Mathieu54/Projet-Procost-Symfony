...
class Employe implements UserInterface
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Metier", inversedBy="metier")
    ...
    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\Production", mappedBy="employe_id")
     */
    private $productions;
    ...
    public function removeProduction(Production $production): self
    {
        if ($this->productions->contains($production)) {
            ...
            $production->removeEmployeId($this);
        }
